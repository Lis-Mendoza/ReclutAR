<div class="login-form-area mg-t-30 mg-b-40">
  ...
  <form id="adminpro-form" class="adminpro-form" action="insertar-admin.php" method="post">
    ...
    <div class="col-lg-6">
      <div class="login-bg">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="login-input-area">
              ...
              <i class="fa fa-lock login-user"></i> </div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4">
        ...
        <div class="row">
          ...
          </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <a href="index.php?menu=registro-perfil-negocio">
          <button type="submit" class="btn btn-custon-four btn-primary">&nbsp;&nbsp;Siguente&nbsp;&nbsp; </button>
          </a> <br>
          <br>
          <br>
        </div>
