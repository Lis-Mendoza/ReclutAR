...
<div class="left-sidebar-pro">
  <nav id="sidebar">
    <div class="sidebar-header"> <a href="#"><img src="logo_chiquito.jpg" class="img-circle" alt="User Image"/> </a>
      <h3>ReclutAR</h3>
      <p>Gestión del personal de Reventa</p>
      <strong>AR</strong> </div>
            ...
            <div class="header-top-menu tabl-d-n">
              <ul class="nav navbar-nav mai-top-nav">
                ...
                <li class="nav-item dropdown"> <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">Quiénes Somos <span class="angle-down-topmenu"><i class="fa fa-angle-down"></i></span></a>
                  <div role="menu" class="dropdown-menu animated flipInX"> <a href="#" class="dropdown-item">Alumna:Lis Mendoza</a> <a href="#" class="dropdown-item">Profesor:Martin Tejerina</a> <a href="#" class="dropdown-item">Institución:I.F.T.S. 11</a> <a href="#" class="dropdown-item">Materia:Seminario II</a> <a href="#" class="dropdown-item">Año:2020</a> </div>
                </li>
...
<li><a data-toggle="collapse" data-target="#Charts" href="index.php?menu=login">Iniciar seción<span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a> </li>
...
<li><a data-toggle="collapse" data-target="#others" href="#">¿		Quiénes somos?<span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
  <ul id="others" class="collapse dropdown-header-top">
    ...
    <li><a href="#">Pofesor: Martin Tejerina</a> </li>
    <li><a href="#">Institución: I.F.T.S. 11</a> </li>
    <li><a href="#">Materia: Seminario II</a> </li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="login-title">
              <h3>Error : ( </h3>
              <h1>Los datos ingresados no son correctos <br>
                <br>
