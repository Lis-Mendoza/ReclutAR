        ...
        <div class="sparkline10-list shadow-reset">
          <div class="sparkline10-hd">
            <div class="main-sparkline10-hd">
              ...
              <div class="sparkline10-outline-icon"> <span class="sparkline10-collapse-link"><i class="fa fa-chevron-up"></i></span> <span class="sparkline10-collapse-close"><i class="fa fa-times"></i></span> </div>
            </div>
          </div>
                ...
                <div class="col-lg-12">
                  <div class="dual-list-box-inner">
                    <form id="form" action="listar-prepedido.php" class="wizard-big" metod=POST>
                      <select class="form-control dual_select"  multiple  id="nombre" required>
                        <?php
...
<script>
    ...
    Swal.fire(
        'Atención! ',
        'Usted debe seleccionar al menos un producto',
        'info'
        )}
    }
       ...
       $.ajax({                        
          ...
          {  
             ...
             console.log(dato);
                ...
                for ( keyProd in lista ) {
                    
              
                  var url = "insertar-linea-pedido.php";
                    $.ajax({                        
                      type: "POST",                
                      url: url,                    
                      data:{"pedido": dato, "id": lista[keyProd].id, "cantidad": lista[keyProd].cant},
                      success: function(resp)            
                      { 
                        $(location).attr('href','pantalla-principal-revendedores.php?menu=listar-pedido');
                      },
                        error: function(resp)            
                      {  
                     $(location).attr('href','pantalla-principal-revendedores.php?menu=listar-pedido');
