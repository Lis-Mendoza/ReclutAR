          ...
          <div style="overflow-y: scroll;height:400px; width: 99%  " >
            <table id="example" class="table table-bordered table-striped " >
              ...
              <tbody id="resp">
                ...
                include( 'logica-listar-pedido-admin.php' );
...
<script>
 ...
 Swal.fire({
     title: 'Esta seguro que desea rechazar este pedido?',
     icon: 'warning',
     ...
     if (result.isConfirmed) {
       ...
       var url = "cambio-estado-pedido.php";
       $.ajax({                        
          type: "POST",                
          url: url,                    
          data:{"id": id},
          ...
          {  
          Swal.fire({
           title: 'El Pedido se rechazó Éxitosamente!',
           icon: 'success',
 ...
 Swal.fire({
     title: 'Esta seguro que desea aprobar este pedido?',
     icon: 'warning',
     showCancelButton: true,
     confirmButtonColor: '#3085d6',
     cancelButtonColor: '#d33',
     ...
     if (result.isConfirmed) {
       ...
       var url = "cambio-estado-pedido-aprobado.php";
       $.ajax({                        
          type: "POST",                
          url: url,                    
          data:{"id": id},
          ...
          {  
          Swal.fire({
           title: 'El Pedido se aprobó Éxitosamente!',
           icon: 'success',
           showCancelButton: false,
           confirmButtonColor: '#3085d6',
           cancelButtonColor: '#d33',
