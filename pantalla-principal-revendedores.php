...
<div class="wrapper-pro">
  <div class="left-sidebar-pro">
    <nav id="sidebar">
      <div class="sidebar-header"> <a href="#"><img src="revendedora_foto.jpg" class="img-circle" alt="User Image" class="img-circle"/> </a>
        <h3>Fran</h3>
        <p>Fain</p>
        <strong>FF</strong> </div>
      <div class="left-custom-menu-adp-wrap">
        <ul class="nav navbar-nav left-sidebar-menu-pro">
          <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-pie-chart"></i> <span class="mini-dn">Mis Pedidos</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX"> <a href="pantalla-principal-revendedores.php?menu=ingreso-pedido" class="dropdown-item">Generar Pedido</a> <a href="pantalla-principal-revendedores.php?menu=listar-pedido" class="dropdown-item">Listar Pedidos </a> </div>
          </li>
          <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-pie-chart"></i> <span class="mini-dn">Mis Ordenes</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX"> <a href="pantalla-principal-revendedores.php?menu=listar-orden" class="dropdown-item">Listar Ordenes </a> </div>
          </li>
          <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-pie-chart"></i> <span class="mini-dn">Mis Incorporaciones</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX"> <a href= "pantalla-principal-revendedores.php?menu=listar-incorporaciones" class="dropdown-item">Listar</a> <a href="../Pantallas/project-details.html" class="dropdown-item">Mis Bonos</a> </div>
          </li>
          <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-pie-chart"></i> <span class="mini-dn">Negocio</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX"> <a href="pantalla-principal-revendedores.php?menu=catalogo" class="dropdown-item">Catalogo</a> </div>
          </li>
          <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-pie-chart"></i> <span class="mini-dn">Mi Perfil</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX"> <a href="pantalla-principal-revendedores.php?menu=actualizar-perfil" class="dropdown-item">Actualizar Perfil</a> </div>
          </li>
            ...
            <div class="col-lg-10 col-md-1 col-sm-1 col-xs-12">
              <div class="header-top-menu tabl-d-n">
                <ul class="nav navbar-nav mai-top-nav">
                  <li class="nav-item"><a href="pantalla-principal-revendedores.php?menu=bienvenida" class="nav-link">Inicio</a> </li>
                ...
                <ul class="mobile-menu-nav">
                  <li><a data-toggle="collapse" data-target="#others" href="#">Mis pedidos <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                    <ul id="others" class="collapse dropdown-header-top">
                      <li><a href="pantalla-principal-revendedores.php?menu=ingreso-pedido">Generar Pedido</a> </li>
                      <li><a href="#">Filtrar Pedidos</a> </li>
                    </ul>
                  </li>
                  <li><a data-toggle="collapse" data-target="#Miscellaneousmob" href="#">Seguimiento de ordenes <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                    <ul id="Miscellaneousmob" class="collapse dropdown-header-top">
                      <li><a href="pantalla-principal-revendedores.php?menu=listar-orden">Listar Ordenes</a> </li>
                    </ul>
                  </li>
                  <li><a data-toggle="collapse" data-target="#Tablesmob" href="#">Mis Incorporaciones <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                    <ul id="Tablesmob" class="collapse dropdown-header-top">
                      ...
                      <li><a href="pantalla-principal-revendedores.php?menu=listar-revendedores">Listar</a> </li>
                    </ul>
                  </li>
                  <li><a data-toggle="collapse" data-target="#formsmob" href="#">Negocio<span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                    <ul id="formsmob" class="collapse dropdown-header-top">
                      <li><a href="catalogo-campaña-1.html">Catalogo</a> </li>
                    </ul>
                  </li>
                  <li><a data-toggle="collapse" data-target="#Appviewsmob" href="#">Mi perfil<span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                    <ul id="Appviewsmob" class="collapse dropdown-header-top">
                      <li><a href="pantalla-principal-revendedores.php?menu=actualizar-perfil">Acualizar Perfil </a> </li>
                    </ul>
                  </li>
