            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="login-button-pro">
                  <div class="button-style-four btn-mg-b-10"> <a href="pantalla-principal.php?menu=bienvenida">
                    <button type="button" class="btn btn-custon-four btn-primary" > Cancelar </button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a> <a href="pantalla-principal.php?menu=insertar-producto">
                    <button type="submit" class="btn btn-custon-four btn-primary">Agregar Producto</button>
                    </a> <br>
                    <br>
                    <br>
                  </div>
