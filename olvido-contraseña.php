<div class="login-form-area mg-t-30 mg-b-40">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="row">
      <div class="col-lg-8">
      <div class="modal-bootstrap modal-login-form"> <a class="zoomInDown mg-t" href="#" data-toggle="modal" data-target="#zoomInDown1">Recuperar mi Contraseña</a> </div>
      <br>
      <br>
      <div class="button-style-four btn-mg-b-15">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="index.php?menu=login">
        <button type="button" class="btn btn-custon-four btn-primary"> &nbsp;&nbsp;&nbsp;&nbsp;Iniciar Sesion &nbsp;&nbsp;&nbsp;&nbsp; </button>
        </a> </div>
      <div id="zoomInDown1" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
      <div class="modal-dialog">
      <div class="modal-content">
      <div class="modal-close-area modal-close-df"> <a class="#"></a> </div>
      ...
      <form action="#">
        ...
        <div class="form-group-inner">
          <div class="row">
            <div class="col-lg-4">
              <label class="login2">Nueva contraseña</label>
            </div>
            <div class="col-lg-8">
          ...
          <div class="form-group-inner">
            <div class="row">
              <div class="col-lg-4">
                <label class="login2">Confirmar contraseña</label>
              </div>
              <div class="col-lg-8">
                <input type="password" class="form-control" placeholder="password"/>
              </div>
